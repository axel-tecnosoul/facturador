                ...
                <div class="col-10">
                  <div class="page-header-left">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">Modificar Pago a Colaborador</li>
                    </ol>
                  </div>
                </div>
                <!-- Bookmark Start-->
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Modificar Pago a Colaborador</h5>
                  </div>
				          <form class="form theme-form" role="form" method="post" action="modificarPagoColaborador.php?id=<?php echo $id?>">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
