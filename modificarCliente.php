                      ...
                      <div class="row">
                        <div class="col">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9"><input name="razon_social" type="text" maxlength="99" class="form-control" value="<?=$data['razon_social']?>" required="required" autofocus></div>
                          </div>
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">CUIT</label>
                            <div class="col-sm-9"><input name="cuit" type="number" maxlength="99" class="form-control" value="<?=$data['cuit']?>"></div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9"><input name="telefono" type="number" maxlength="99" class="form-control" value="<?=$data['telefono']?>"></div>
                          </div>
                          <div class="form-group row">
