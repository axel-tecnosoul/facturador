...
if(!empty($_POST)){
  $query = "SELECT id, usuario, clave, activo FROM usuarios WHERE activo = 1 and usuario = :user";
  ...
  if($login_ok){
    ...
    die("Redirecting to: listarCobros.php");
  }else{
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="auth-innerright">
                <div class="text-center"><img src="assets/images/logo.jpg" width="350px" alt=""></div>
